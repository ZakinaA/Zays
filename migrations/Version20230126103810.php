 ...
 */
final class Version20230126103810 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE paiement ADD mouvement_id INT DEFAULT NULL, ADD caf VARCHAR(5) DEFAULT NULL, DROP source');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE paiement ADD source VARCHAR(100) DEFAULT NULL, DROP mouvement_id, DROP caf');
    }
}
